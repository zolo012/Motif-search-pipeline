...
# Calculate iupred score of all motifs in found_better_motif_dict then keep all of them or remove those that have less iupred score than the threshold
...
# Create a dictionary {protein_id : [iupred_score]} within there're iupred score of all proteins from a dictionary (see below) then create files containing iupred score of proteins separately
# where at least the first keys must be protein ids: {id : ..., id2 : ...}
