...
########################################################################################################################
# 						Motif candidates analysis
#						based on (3) their position in the proteins
#						or the location of proteins
########################################################################################################################
...
# inputs: qfo_dictionary created by ox_to_phyl_lev_to_ord_numb_convert
...
# Create a dictionary within the motifs' occurrence in other species (OXs) are placed in phylogenetic groups: {id : {original_motif : {app_numb : {group : [ox1, ox2]}}}}}}
...
# Create a tsv file from dictionary created by evol_cons_calculate algorithm with all phylgroup display
